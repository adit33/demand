        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   <?php echo Form::model($user,['url'=>route('user.update',$user->nik),'method'=>'PUT','class'=>'form-horizontal']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <?php echo Form::select('nama_role',App\Models\Role::pluck('nama_role','nama_role'),$nama_role,['class'=>'form-control','placeholder'=>'Pilih Role']); ?>
