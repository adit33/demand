        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   {!! Form::model($user,['url'=>route('user.update',$user->nik),'method'=>'PUT','class'=>'form-horizontal']) !!}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('nama_role',App\Models\Role::pluck('nama_role','nama_role'),$nama_role,['class'=>'form-control','placeholder'=>'Pilih Role']) !!}
